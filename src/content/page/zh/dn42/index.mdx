...
1. 中国香港，Yuusei Network 服务商

   - 域名：`alice.lantian.pub`
   - 公网 IPv4：`2.26.205.141` / `v4.alice.lantian.pub`
   - 公网 IPv6：`2a14:67c4:12::c3` / `v6.alice.lantian.pub`
...
3. 美国洛杉矶，BandwagonHost 服务商
   ...
   - 公网 IPv6：`2607:8700:5501:574f::2` / `v6.bwg-lax.lantian.pub`
...
4. 美国纽约，ColoCrossing 服务商

   - 域名：`colocrossing.lantian.pub`
   - 公网 IPv4：`23.94.65.218` / `v4.colocrossing.lantian.pub`
   - 公网 IPv6：`2001:470:1f07:6fe::1` / `v6.colocrossing.lantian.pub`
