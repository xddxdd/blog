...
- [My FlapAlerted](https://flapalerted.lantian.pub/)
  - [FlapAlerted](github.com/Kioubit/FlapAlerted) can show which routes are frequently changing. It usually indicates a configuration error where routes switch back and forth between multiple available routes.
  - Also see [How to Kill the DN42 Network](https://lantian.pub/en/article/modify-website/how-to-kill-the-dn42-network.lantian/#route-flapping)
- Route ROA filtering stats
  ...
  - Invalid route: this IP block is registered in DN42, but the actual source of
    ...
    - If you cannot see the list of routes, click the "All Servers" link on the top left to see routes from all nodes.
...
1. Hong Kong, China, provider Yuusei Network

   - Domain: `alice.lantian.pub`
   - Public IPv4: `2.26.205.141` / `v4.alice.lantian.pub`
   - Public IPv6: `2a14:67c4:12::c3` / `v6.alice.lantian.pub`
   - DN42 IPv4: `172.22.76.186` / `v4.alice.dn42.lantian.pub`
   - DN42 IPv6: `fdbc:f9dc:67ad:1::1` / `v6.alice.dn42.lantian.pub`
...
3. Los Angeles, United States, provider BandwagonHost

   - Domain: `bwg-lax.lantian.pub`
   - Public IPv4: `64.64.231.82` / `v4.bwg-lax.lantian.pub`
   - Public IPv6: `2607:8700:5501:574f::2` / `v6.bwg-lax.lantian.pub`
...
4. New York, United States, provider ColoCrossing

   - Domain: `colocrossing.lantian.pub`
   - Public IPv4: `23.94.65.218` / `v4.colocrossing.lantian.pub`
   - Public IPv6: `2001:470:1f07:6fe::1` / `v6.colocrossing.lantian.pub`
   - DN42 IPv4: `172.22.76.190` / `v4.colocrossing.dn42.lantian.pub`
   - DN42 IPv6: `fdbc:f9dc:67ad:8::1` / `v6.colocrossing.dn42.lantian.pub`
   - Link-local IPv6: `fe80::2547`
   - WireGuard Public Key: `a+zL2tDWjwxBXd2bho2OjR/BEmRe2tJF9DHFmZIE+Rk=`

5. Bern, Switzerland, provider BuyVM
