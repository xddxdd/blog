(function () {
    ...
    var ab = function (a, b, c, d) {
        ...
        db = function () {};
    var gb =
            (qa(window.GoogleAnalyticsObject) &&
                sa(window.GoogleAnalyticsObject)) ||
            'ga',
        Ba = !1,
        hb = T('apiVersion', 'v'),
    ...
    var hc = !1,
        mc = function (a) {
            'cookie' == P(a, ac) &&
                (ma(a, Q, U), a.get(ja) && ma(a, I, la, 864e5));
        },
        ma = function (a, b, c, d) {
            var e = nd(a, b);
            if (e) {
    ...
    var p = /^(GTM|OPT)-[A-Z0-9]+$/,
        ...
        t = function (a) {
            ...
            var c = 'https://lantian.pub/analyticsproxy/gtm/js?id=' + K(a.id);
    ...
    var Sd = function (a) {
        if (!a.get('dcLoaded') && 'cookie' == a.get(ac)) {
            ...
            Pd(b, a, ia);
            Qd(b, a);
            a.get(b.U) && (a.set(Md, 1, !0), a.set(gd, oc() + '/collect', !0));
        }
    };
    var Lc = function () {
    ...
    var H = function (a) {
        ...
        da = function (a) {
            ...
            if (b && b.getEntriesByName) {
                J(35);
                var c =
                    'https://lantian.pub/analyticsproxy/analytics.js?wpid=' + a;
                wa(c, void 0, void 0, function () {
                    try {
                        var d = 1,
                            e = b.getEntriesByName(
                                'https://lantian.pub/analyticsproxy/analytics.js',
                            );
                        (e && 0 != e.length) ||
                            ((e = b.getEntriesByName(
                                'http://lantian.pub/analyticsproxy/analytics.js',
                            )),
                            (d = 0));
                        ...
                        if (e && 1 == e.length && g && 1 == g.length) {
                            ...
                            var ca = e[0],
                                ...
                                k = {
                                    ...
                                    an: H(
                                        ca.domainLookupEnd -
                                            ca.domainLookupStart,
                                    ),
                                    bn: H(
                                        l.domainLookupEnd - l.domainLookupStart,
                                    ),
                            ...
                            d.push('z=' + hd());
                            wc(
                                'https://lantian.pub/analyticsproxy/u/d',
                                d.join('&'),
                                ua,
                            );
                        }
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function (a, b) {
            a.data.set(
                ja,
                a.get(ja) || 1 == Ed(new Od(1, !0), void 0, La(a.get(Q))),
            );
            if (a.get(ja)) {
                var c = P(a, U);
            ...
            a: if (
                ((c = a.get(cc)),
                (d = E(M.location[c ? 'href' : 'search'], '_ga')))
            )
                if (a.get(bc))
                    ...
                    c = function () {
                        if (!b && rc(a)) {
                            ...
                            e.removeEventListener
                                ...
                                : e.detachEvent &&
                                  e.detachEvent('onvisibilitychange', d);
                        }
                    };
    ...
    var u = function (a, b, c) {
            ...
            if (!ea(Yd.get(b)) && !$d.get(b)) {
                ...
                c &&
                    ((c && 0 <= c.indexOf('/')) ||
                        (c =
                            (Ba || Ud() ? 'https:' : 'http:') +
                            '//lantian.pub/analyticsproxy/plugins/ua/' +
                            c),
                    (d = ae(c)),
                    (a = d.protocol),
        ...
        B = function (a) {
            ...
            if (D(a.url, 'https://lantian.pub/analyticsproxy/gtm/js?id='))
                return !0;
            if (
                a.query ||
                0 <= a.url.indexOf('?') ||
            ...
            return 'lantian.pub/analyticsproxy' == a.host &&
                (a.port || b) == b &&
                D(a.path, '/plugins/')
                ? !0
                : !1;
    ...
    N.N = function () {
        ...
        if (!a || 42 != a.answer) {
            ...
            if (!Ud() && !Ba) {
                a: {
                    for (
                        var b = M.getElementsByTagName('script'), c = 0;
                        c < b.length && 100 > c;
                        c++
                    ) {
                        var d = b[c].src;
                        if (
                            ...
                            0 ==
                                d.indexOf(
                                    'https://lantian.pub/analyticsproxy/analytics',
                                )
                        ) {
                            J(33);
                            b = !0;
