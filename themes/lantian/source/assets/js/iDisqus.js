...
(function (global) {
    ...
    iDisqus.prototype.init = function () {
        ...
        _.dom.innerHTML = `<div class="comment init"id=idisqus><div class=comment-reaction><div class=comment-reaction-header><div class=comment-reaction-prompt></div><div class=comment-reaction-total></div></div><div class=comment-reaction-list></div></div><div class=init-container data-tips=正在初始化……><svg class=init-bg height=72 version=1.1 viewBox="0 0 720 720"width=72 xmlns=http://www.w3.org/2000/svg><path d="M 0 -260 A 260 260 0 1 1 -80 -260"fill=none class=ring stroke=#9d9ea1 stroke-width=50 transform=translate(400,400) /><polygon points="50,0 0,100 18,145 50,82 92,145 100,100"style=fill:#9d9ea1 transform=translate(305,20) /></svg></div><div class=comment-header><div class=comment-header-primary><span class=comment-header-item id=comment-count>评论</span> <a class=comment-header-item id=comment-link target=_blank>在线讨论</a></div><div class=comment-header-menu><input class=comment-header-checkbox type=checkbox id=comment-user> <label class="comment-header-item comment-login"for=comment-user title="使用 Disqus 帐号授权登录">登录</label></div></div><div class=comment-navbar><div class=comment-navbar-item><a class=comment-recommend href=javascript:;><svg class=icon height=24 version=1.1 viewBox="0 0 1024 1024"width=24 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink p-id=3234 t=1537508059126><path d="M489.993 887.107 177.906 586.021c-4.002-3.501-114.033-104.031-114.033-224.063 0-146.54 89.526-234.065 239.069-234.065 87.523 0 169.546 69.019 209.058 108.03 39.512-39.011 121.535-108.03 209.059-108.03 149.542 0 239.068 87.525 239.068 234.065 0 120.033-110.031 220.563-114.533 225.065L534.007 887.107c-6 6-14.003 9-22.007 9C503.997 896.107 495.993 893.107 489.993 887.107z"p-id=3235></path></svg><span class=comment-recommend-text>推荐</span><span class=comment-recommend-count></span></a></div><div class="comment-navbar-item comment-order"><input class=comment-order-radio type=radio id=order-popular name=comment-order value=popular> <label class=comment-order-label for=order-popular title=按评分高低排序>最佳</label> <input class=comment-order-radio type=radio id=order-desc name=comment-order value=desc> <label class=comment-order-label for=order-desc title=按从新到旧排序>最新</label> <input class=comment-order-radio type=radio id=order-asc name=comment-order value=asc> <label class=comment-order-label for=order-asc title=按从旧到新排序>最早</label></div></div><div class=comment-box><div class="avatar comment-avatar"><img class=comment-avatar-image data-avatar=//a.disquscdn.com/images/noavatar92.png src=//a.disquscdn.com/images/noavatar92.png></div><div class=comment-form><div class=comment-form-wrapper><textarea class=comment-form-textarea placeholder=加入讨论……></textarea><div class=comment-form-alert></div><div class=comment-image><ul class=comment-image-list></ul><div class=comment-image-progress><div class=comment-image-loaded></div></div></div><div class=comment-actions><div class=comment-actions-group><input class=comment-actions-input type=checkbox id=emoji-input> <label class="comment-actions-label emojione"for=emoji-input><svg class=icon height=200 version=1.1 viewBox="0 0 1024 1024"width=200 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink fill=#c2c6cc><g><title>选择表情</title><path d="M512 1024c-282.713043 0-512-229.286957-512-512s229.286957-512 512-512c282.713043 0 512 229.286957 512 512S792.486957 1024 512 1024zM512 44.521739c-258.226087 0-467.478261 209.252174-467.478261 467.478261 0 258.226087 209.252174 467.478261 467.478261 467.478261s467.478261-209.252174 467.478261-467.478261C979.478261 253.773913 768 44.521739 512 44.521739z"></path><path d="M801.391304 554.295652c0 160.278261-129.113043 289.391304-289.391304 289.391304s-289.391304-129.113043-289.391304-289.391304L801.391304 554.295652z"></path><path d="M674.504348 349.495652m-57.878261 0a2.6 2.6 0 1 0 115.756522 0 2.6 2.6 0 1 0-115.756522 0Z"></path><path d="M347.269565 349.495652m-57.878261 0a2.6 2.6 0 1 0 115.756522 0 2.6 2.6 0 1 0-115.756522 0Z"></path></g></svg><ul class=emojione-list>${ emojiList}</ul></label> <input class="comment-actions-input comment-image-input"type=file id=upload-input name=file accept=image/*> <label class=comment-actions-label for=upload-input><svg class=icon height=200 version=1.1 viewBox="0 0 1024 1024"width=200 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink fill=#c2c6cc><g><title>上传图片</title><path d="M15.515152 15.515152 15.515152 15.515152 15.515152 15.515152Z"></path><path d="M15.515152 139.636364l0 806.787879 992.969697 0 0-806.787879-992.969697 0zM946.424242 884.363636l-868.848485 0 0-682.666667 868.848485 0 0 682.666667zM698.181818 356.848485c0-51.417212 41.673697-93.090909 93.090909-93.090909s93.090909 41.673697 93.090909 93.090909c0 51.417212-41.673697 93.090909-93.090909 93.090909s-93.090909-41.673697-93.090909-93.090909zM884.363636 822.30303l-744.727273 0 186.181818-496.484848 248.242424 310.30303 124.121212-93.090909z"></path></g></svg></label></div><div class=comment-actions-form><button class=comment-form-submit><svg class=icon height=200 version=1.1 viewBox="0 0 1024 1024"width=200 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink><path d="M565.747623 792.837176l260.819261 112.921839 126.910435-845.424882L66.087673 581.973678l232.843092 109.933785 562.612725-511.653099-451.697589 563.616588-5.996574 239.832274L565.747623 792.837176z"fill=#ffffff></path></svg></button></div></div></div><div class=comment-form-user><form class=comment-form-guest><input class="comment-form-input comment-form-name"name=name autocomplete=name placeholder=名字（必填）><input class="comment-form-input comment-form-email"type=email name=email autocomplete=email placeholder=邮箱（必填）><input class="comment-form-input comment-form-url"type=url name=url autocomplete=url placeholder=网址（可选）></form></div></div></div><ul class=comment-list data-tips=评论加载中…… id=comments></ul><a class="comment-loadmore hide"href=javascript:;>加载更多</a><div class=comment-related></div></div><div class=comment id=disqus_thread></div>`;
            ...
            function (resp) {
                ...
                if (data.code == 0) {
                    ...
                    threads.forEach(function (item) {
                        ...
                        popHtml += `<li class=related-item><a class=related-item-link href=${item.link} title=${item.title}><div class=related-item-title>${item.title}</div><div class=related-item-desc>${item.posts}条评论<span class=related-item-bullet> • </span><time class=related-item-time datetime=${item.createdAt}></time></div></a><a class=related-item-link href=${item.link}?#comment-${item.topPost.id} title=${message}><div class=related-item-post><div class=related-item-avatar><img src=${item.topPost.avatar}></div><div class=related-item-main><div class=related-item-name>${ item.topPost.name}</div><div class=related-item-message>${ message}</div></div></div></a>`;
                    });
    ...
    iDisqus.prototype.load = function (post) {
        ...
        var parentPost = !!post.parent ? {
            name: `<a class=comment-item-pname data-parent=${post.parent} href=#${parentPostDom.id}><svg class=icon height=200 version=1.1 viewBox="0 0 1024 1024"width=200 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink><path d="M1.664 902.144s97.92-557.888 596.352-557.888V129.728L1024 515.84l-425.984 360.448V628.8c-270.464 0-455.232 23.872-596.352 273.28"></path></svg>${parentPostDom.dataset.name}</a>`,
        ...
        var html = `<li class=comment-item data-id=${post.id} data-name=${post.name} id=comment-${post.id}><div class=comment-item-body><a class=comment-item-avatar href="#comment-${ post.id}"><img src=${post.avatar}></a><div class=comment-item-main><div class=comment-item-header><a class=comment-item-name href="${(post.url || 'javascript:;')}"rel=nofollow target=_blank title="${ post.name}">${post.name}</a>${(post.isMod ? `<span class=comment-item-badge>${_.opts.badge}</span>` : ``)}${parentPost.name}<span class=comment-item-bullet> • </span><time class=comment-item-time datetime=${post.createdAt}></time></div><div class=comment-item-content>${ post.message}</div><div class=comment-item-footer>${!!post.isPost ? `<span class=comment-item-manage><a class=comment-item-edit href=javascript:;>编辑</a><span class=comment-item-bullet> • </span><a class=comment-item-delete href=javascript:;>删除</a><span class=comment-item-bullet> • </span></span>` : ``}<a class=comment-item-reply href=javascript:;>回复</a></div></div></div><ul class=comment-item-children>${ post.hasMore ? `<li><a class=comment-item-loadmore href=javascript:;>显示更多回复</a></li>` : `` }</ul>`;

        // 已删除评论
        if (!!post.isDeleted) {
            html = `<li class=comment-item data-id=${post.id} data-name=${post.name} id=comment-${post.id}><div class=comment-item-body><a class=comment-item-avatar href="#comment-${ post.id}"><img src=${post.avatar}></a><div class=comment-item-main data-message=此评论已被删除。></div></div><ul class=comment-item-children>${ post.hasMore ? `<li><a class=comment-item-loadmore href=javascript:;>显示更多回复</a></li>` : `` }</ul>`;
        }
    ...
    iDisqus.prototype.upload = function (e, target) {
        ...
        xhrUpload.upload.addEventListener('load', function (e) {
            ...
            var imageItem = `<li class="comment-image-item loading"data-image-size=${size}><svg class=comment-image-object height=30px style="enable-background:new 0 0 50 50"version=1.1 viewBox="0 0 24 30"width=24px x=0px xml:space=preserve xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink y=0px><rect fill=rgba(127,145,158,1) height=10 opacity=0.2 width=4 x=0 y=10><animate attributeName=opacity attributeType=XML begin=0s dur=0.6s repeatCount=indefinite values="0.2; 1; .2"/><animate attributeName=height attributeType=XML begin=0s dur=0.6s repeatCount=indefinite values="10; 20; 10"/><animate attributeName=y attributeType=XML begin=0s dur=0.6s repeatCount=indefinite values="10; 5; 10"/></rect><rect fill=rgba(127,145,158,1) height=10 opacity=0.2 width=4 x=8 y=10><animate attributeName=opacity attributeType=XML begin=0.15s dur=0.6s repeatCount=indefinite values="0.2; 1; .2"/><animate attributeName=height attributeType=XML begin=0.15s dur=0.6s repeatCount=indefinite values="10; 20; 10"/><animate attributeName=y attributeType=XML begin=0.15s dur=0.6s repeatCount=indefinite values="10; 5; 10"/></rect><rect fill=rgba(127,145,158,1) height=10 opacity=0.2 width=4 x=16 y=10><animate attributeName=opacity attributeType=XML begin=0.3s dur=0.6s repeatCount=indefinite values="0.2; 1; .2"/><animate attributeName=height attributeType=XML begin=0.3s dur=0.6s repeatCount=indefinite values="10; 20; 10"/><animate attributeName=y attributeType=XML begin=0.3s dur=0.6s repeatCount=indefinite values="10; 5; 10"/></rect></svg>`;
    ...
    iDisqus.prototype.threadInit = function (e, target) {
        ...
        getAjax(_.opts.api + '/threadsDetails.php?ident=' + _.opts.identifier + '&link=' + _.opts.url, function (resp) {
            ...
            if (data.code == 0) {
                ...
                _.dom.querySelector('#idisqus').classList.remove('init');
                var threadForm = `<div class=comment-header><span class=comment-header-item>创建 Thread</span></div><div class=comment-thread-form><p>由于 Disqus 没有本页面的相关 Thread，故需先创建 Thread<div class=comment-form-item><label class=comment-form-label>url:</label><input class=comment-form-input id=thread-url name=url value="${ _.opts.link}"disabled></div><div class=comment-form-item><label class=comment-form-label>identifier:</label><input class=comment-form-input id=thread-identifier name=identifier value="${ _.opts.identifier}"disabled></div><div class=comment-form-item><label class=comment-form-label>title:</label><input class=comment-form-input id=thread-title name=title value="${ _.opts.title}"disabled></div><div class=comment-form-item><label class=comment-form-label>slug:</label><input class=comment-form-input id=thread-slug name=slug value="${ _.opts.slug}"></div><div class=comment-form-item><label class=comment-form-label>message:</label><textarea class=comment-form-textarea id=thread-message name=message>${ _.opts.desc}</textarea></div><button class=comment-form-submit id=thread-submit>提交</button></div>`;
